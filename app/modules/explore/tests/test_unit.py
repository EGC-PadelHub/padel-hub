...
def populated_db(clean_database):
    try:
        ...
        fm_meta1 = FMMetaData(title="FM Meta 1", description="FM de Padel", uvl_filename="fm_padel.uvl", publication_type=PublicationType.REPORT)
        fm_meta2 = FMMetaData(title="FM Meta 2", description="FM de Tenis", uvl_filename="fm_tenis.uvl", publication_type=PublicationType.BOOK)
        fm_meta3 = FMMetaData(title="FM Meta 3", description="FM de Padel 2", uvl_filename="fm_padel_2.uvl", publication_type=PublicationType.REPORT)
