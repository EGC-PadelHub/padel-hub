...
class ZenodoService(BaseService):
    ...
    def get_zenodo_url(self):
        ...
        default_fakenodo = "http://127.0.0.1:5000/fakenodo/api/deposit/depositions"
    ...
    def __init__(self):
        ...
        fakenodo_candidates = [os.getenv("FAKENODO_URL"), "http://127.0.0.1:5000/fakenodo/api/deposit/depositions"]
    ...
    def upload_file(self, dataset: DataSet, deposition_id: int, file: Hubfile, user=None) -> dict:
        ...
        Args:
            ...
            file (Hubfile): The Hubfile object representing the file to upload.
