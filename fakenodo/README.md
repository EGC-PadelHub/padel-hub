...
- Data storage: JSON file at `fakenodo/data/store.json` plus uploaded files under `fakenodo/data/uploads/`.

## Run locally

```bash
# activate your virtualenv and install Flask if needed
python fakenodo/app.py
